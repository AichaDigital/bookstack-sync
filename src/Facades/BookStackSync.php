 ...
 * @method static ShelfDTO createShelf(string $name, ?string $description = null, array<int> $bookIds = [])
 ...
 * @method static array{created: int, updated: int, deleted: int, skipped: int, errors: array<string>} pushToBook(string $localPath, int $bookId)
 * @method static array{created: int, updated: int, skipped: int, errors: array<string>} pullFromBook(int $bookId, string $localPath)
